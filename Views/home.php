                ...
                <div class="col-lg-12">
                    ...
                    <div class="button-group filters-button-group">
                        <button class="button is-checked" data-filter="*">
                          <img class="img-fluid text-filters" src="Assets/images/iconohome.png" alt="alternative" width="30px" height="30px"><br>  
                                ALL
                        </button>
                        <button class="button" data-filter=".agricultura">
                            <img class="img-fluid text-filters" src="Assets/images/iconoglobe.png" alt="alternative" width="30px" height="30px"><br>
                            Agricultura
                        </button>
                        <button class="button" data-filter=".fabricas">
                            <img class="img-fluid text-filters" src="Assets/images/iconodiana.png" alt="alternative" width="30px" height="30px"><br>
                            Fabricas
                        </button>
                        <button class="button" data-filter=".talleres">
                            <img class="img-fluid text-filters" src="Assets/images/iconoherramienta.png" alt="alternative" width="30px" height="30px"><br>
                            Talleres
                        </button>
                        <button class="button" data-filter=".hosteleria">
                            <img class="img-fluid text-filters" src="Assets/images/iconotiempo.png" alt="alternative" width="30px" height="30px"><br>
                            Hosteleria
                        </button>
                        <button class="button" data-filter=".bancaseguros">
                            <img class="img-fluid text-filters" src="Assets/images/iconomoneda.png" alt="alternative" width="30px" height="30px"><br>
                            Banca / Seguros
                        </button>
                        <button class="button" data-filter=".inmobiliarias">
                            <img class="img-fluid text-filters" src="Assets/images/iconoinmobiliaria.png" alt="alternative" width="30px" height="30px"><br>
                            Inmobiliarias
                        </button>
                        <button class="button" data-filter=".educacion">
                            <img class="img-fluid text-filters" src="Assets/images/iconolapiz.png" alt="alternative" width="30px" height="30px"><br>
                            Educación
                        </button>
                        <button class="button" data-filter=".sanitarias">
                            <img class="img-fluid text-filters" src="Assets/images/iconosanidad.png" alt="alternative" width="30px" height="30px"><br>
                            Sanitaria
                        </button>
                         <button class="button" data-filter=".informatica">
                            <img class="img-fluid text-filters" src="Assets/images/iconomonitor.png" alt="alternative" width="30px" height="30px"><br>
                            Informatica
                        </button>
...
<!--Fin de la paginación de las cards-->
